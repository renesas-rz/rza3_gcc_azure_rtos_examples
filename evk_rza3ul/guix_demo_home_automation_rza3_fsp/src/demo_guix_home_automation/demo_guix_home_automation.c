...
extern void mouse_thread_entry(ULONG thread_input);
...
/******************************************************************************************/
VOID init_demo_guix_home_automation(void *first_unused_memory)
{
...
VOID  guix_setup()
{
    ...
    /* Configure display. */
    gx_studio_display_configure(DISPLAY_1, rz_a3_graphics_driver_setup_32argb,//win32_graphics_driver_setup_24xrgb,
