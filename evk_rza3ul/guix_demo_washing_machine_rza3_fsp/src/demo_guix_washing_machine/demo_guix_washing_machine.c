...
/******************************************************************************************/
VOID init_demo_guix_washing_machine(void *first_unused_memory)
{
...
VOID  guix_setup()
{
    ...
    /* Configure display. */
    gx_studio_display_configure(MAIN_DISPLAY, rz_a3_graphics_driver_setup_32argb,//win32_graphics_driver_setup_24xrgb,
