...
/*****************************************************************************/
VOID init_demo_guix_widget_types(void *first_unused_memory)
{
...
VOID start_guix(void)
{
    ...
    gx_studio_display_configure(PRIMARY, rz_a3_graphics_driver_setup_32argb,//win32_graphics_driver_setup_24xrgb,
