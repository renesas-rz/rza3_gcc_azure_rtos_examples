...
UINT            server_port;
    ...
    /* Build client id.  */
    buffer_length = (size_t)buffer_size;
...
az_result core_result;
    ...
    topic_length = (size_t)(packet_ptr -> nx_packet_data_end - packet_ptr -> nx_packet_prepend_ptr);
...
size_t sas_buffer_len_tmp;
    ...
    sas_buffer_len_tmp = (size_t)sas_buffer_len;
    core_result= az_iot_hub_client_sas_get_password(&(hub_client_ptr -> iot_hub_client_core),
                                                    ...
                                                    (CHAR *)sas_buffer, sas_buffer_len_tmp, (size_t *)&sas_buffer_len_tmp);
    if (az_result_failed(core_result))
    {
