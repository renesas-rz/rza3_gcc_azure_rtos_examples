...
/* Defined, DPS is enabled. change not#define IoT Hub & #define IoT central*/
//#define USE_SAMPLE_AZURE_IOT_EMBEDDED_SDK       /* Compile sample_azure_iot_embedded_sdk.c */
#define USE_SAMPLE_AZURE_IOT_EMBEDDED_SDK_PNP   /* Compile sample_azure_iot_embedded_sdk_pnp.c  */
