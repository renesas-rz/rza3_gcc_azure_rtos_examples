...
{
#if (UINTPTR_MAX != UINT32_MAX)
    ULONG   ux_hcd_ohci_hcd_owner;
    ULONG   ux_hcd_ohci_hcca;
    ULONG * ux_hcd_ohci_hcor;
    UINT    ux_hcd_ohci_nb_root_hubs;
    ULONG   ux_hcd_ohci_done_head;
    ULONG   ux_hcd_ohci_ed_list;
    ULONG   ux_hcd_ohci_td_list;
    ULONG   ux_hcd_ohci_iso_td_list;
...
typedef struct UX_OHCI_ED_STRUCT
{
    ...
    ULONG ux_ohci_ed_tail_td;
    ULONG ux_ohci_ed_head_td;
    ULONG ux_ohci_ed_next_ed;
    ULONG ux_ohci_ed_previous_ed;
    ULONG ux_ohci_ed_status;
    ULONG ux_ohci_ed_endpoint;
...
{                                                
    ...
    ULONG ux_ohci_td_cbp;
    ULONG ux_ohci_td_next_td;
    ULONG ux_ohci_td_be;
    ULONG ux_ohci_td_reserved_1[4];
    ULONG ux_ohci_td_transfer_request;
    ULONG ux_ohci_td_next_td_transfer_request;
    ULONG ux_ohci_td_ed;
...
typedef struct UX_OHCI_ISO_TD_STRUCT
{
    ...
    ULONG  ux_ohci_iso_td_bp0;
    ULONG  ux_ohci_iso_td_next_td;
    ULONG  ux_ohci_iso_td_be;
    USHORT ux_ohci_iso_td_offset_psw[8];
    ULONG  ux_ohci_iso_td_transfer_request;
    ULONG  ux_ohci_iso_td_next_td_transfer_request;
    ULONG  ux_ohci_iso_td_ed;
