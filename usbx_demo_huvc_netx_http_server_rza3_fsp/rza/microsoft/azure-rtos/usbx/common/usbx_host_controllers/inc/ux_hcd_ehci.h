...
{                                      
#if (UINTPTR_MAX != UINT32_MAX)
    ULONG        ux_hcd_ehci_hcd_owner;
    ULONG        ux_hcd_ehci_hcor;
    ULONG      * ux_hcd_ehci_frame_list;
    ULONG      * ux_hcd_ehci_base;
    UINT         ux_hcd_ehci_nb_root_hubs;
    ULONG        ux_hcd_ehci_done_head;
    ULONG        ux_hcd_ehci_ed_list;
    ULONG        ux_hcd_ehci_td_list;
    ULONG        ux_hcd_ehci_fsiso_td_list;
    ULONG        ux_hcd_ehci_hsiso_td_list;
    ULONG        ux_hcd_ehci_asynch_head_list;
    ULONG        ux_hcd_ehci_asynch_first_list;
    ULONG        ux_hcd_ehci_asynch_last_list;
    ULONG        ux_hcd_ehci_hsiso_scan_list;
    ULONG        ux_hcd_ehci_fsiso_scan_list;
    ULONG        ux_hcd_ehci_iso_done_transfer_head;
    ULONG        ux_hcd_ehci_iso_done_transfer_tail;
    ULONG        ux_hcd_ehci_interrupt_ed_list;
...
{                                      
#if (UINTPTR_MAX != UINT32_MAX)
    ULONG ux_ehci_ed_queue_head;
    ULONG ux_ehci_ed_cap0;
    ULONG ux_ehci_ed_cap1;

    ULONG ux_ehci_ed_current_td;
    ULONG ux_ehci_ed_queue_element;
    ULONG ux_ehci_ed_alternate_td;

    ULONG ux_ehci_ed_state;
    ULONG ux_ehci_ed_bp0;
    ULONG ux_ehci_ed_bp1;
    ULONG ux_ehci_ed_bp2;
    ULONG ux_ehci_ed_bp3;
    ULONG ux_ehci_ed_bp4;

    /* 12 DWords, 48 bytes QH for controller end.  */

    ULONG ux_ehci_ed_status;
    ULONG ux_ehci_ed_next_ed;
    ULONG ux_ehci_ed_previous_ed;

    ULONG ux_ehci_ed_first_td;
    ULONG ux_ehci_ed_last_td;
    union
    {
        struct                                            /* For anchor.  */
        {
            ULONG  ux_ehci_ed_next_anchor;                /* + 1 DWord.   */
            USHORT ux_ehci_ed_microframe_load[8];         /* + 4 DWords.  */
            UCHAR  ux_ehci_ed_microframe_ssplit_count[8]; /* + 2 DWords.  */
        } ANCHOR;
        struct                                            /* As interrupt ED.  */
        {
            ULONG ux_ehci_ed_anchor;                      /* + 1 DWord.  */
            ULONG ux_ehci_ed_endpoint;                    /* + 1 Dword.  */
        } INTR;
...
{                                      
#if (UINTPTR_MAX != UINT32_MAX)
    ULONG ux_ehci_td_link_pointer;
    ULONG ux_ehci_td_alternate_link_pointer;
    ULONG ux_ehci_td_control;
    ULONG ux_ehci_td_bp0;
    ULONG ux_ehci_td_bp1;
    ULONG ux_ehci_td_bp2;
    ULONG ux_ehci_td_bp3;
    ULONG ux_ehci_td_bp4;

    /* 8-DWords, 32-bytes qTD for controller.  */
    ULONG ux_ehci_td_transfer_request;
    ULONG ux_ehci_td_next_td_transfer_request;
    ULONG ux_ehci_td_ed;
...
{
#if (UINTPTR_MAX != UINT32_MAX)
    ULONG ux_ehci_hsiso_ed_endpoint;
    ULONG ux_ehci_hsiso_ed_anchor;
    ULONG ux_ehci_hsiso_ed_transfer_head;
    ULONG ux_ehci_hsiso_ed_transfer_tail;
    ULONG ux_ehci_hsiso_ed_transfer_first_new;
    ULONG ux_ehci_hsiso_ed_fr_td[4];
...
typedef struct UX_EHCI_HSISO_TD_STRUCT
{
    ...
    ULONG ux_ehci_hsiso_td_next_scan_td;
    ULONG ux_ehci_hsiso_td_previous_scan_td;
    ULONG ux_ehci_hsiso_td_fr_transfer[3];
    ULONG ux_ehci_hsiso_td_ed;
...
typedef struct UX_EHCI_FSISO_TD_STRUCT
{
    ...
    ULONG ux_ehci_fsiso_td_bp[2];
    ULONG ux_ehci_fsiso_td_back_pointer;
    ...
    UCHAR reserved[1];
    ULONG ux_ehci_fsiso_td_endpoint;
    ULONG ux_ehci_fsiso_td_transfer_head;
    ULONG ux_ehci_fsiso_td_transfer_tail;
    union UX_EHCI_PERIODIC_LINK_POINTER_UNION
          ux_ehci_fsiso_td_previous_lp;
    ULONG ux_ehci_fsiso_td_next_scan_td;
    ULONG ux_ehci_fsiso_td_previous_scan_td;
    ULONG ux_ehci_fsiso_td_anchor;
    ULONG ux_ehci_fsiso_td_next_ed_td;
