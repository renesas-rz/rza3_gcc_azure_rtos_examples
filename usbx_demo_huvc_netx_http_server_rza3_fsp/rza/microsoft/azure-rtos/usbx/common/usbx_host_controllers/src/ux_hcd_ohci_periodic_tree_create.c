    ...
    for (list_index = 0; list_index < 6; list_index++)
    {
        ...
        for (current_list_entry = 0; current_list_entry < list_entries;current_list_entry++)
        {
            ...
            else
            {
                ...
                ((UX_OHCI_ED*)(ed_list[current_list_entry * 2])) -> ux_ohci_ed_next_ed =        _ux_utility_physical_address(ed);
                ((UX_OHCI_ED*)(ed_list[(current_list_entry * 2) + 1])) -> ux_ohci_ed_next_ed =  _ux_utility_physical_address(ed);
            }
