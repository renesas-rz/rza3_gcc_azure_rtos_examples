...
ULONG                         max_packet_size;
    ...
    _ux_hcd_ehci_periodic_descriptor_link((VOID*)ed -> ux_ehci_ed_previous_ed,
            UX_NULL, UX_NULL, (VOID*)ed -> ux_ehci_ed_queue_head);
    ...
    for(frindex = 0; frindex < 8; frindex ++)
    {
        ...
        if ((ed -> ux_ehci_ed_cap1 & (UX_EHCI_SMASK_0 << frindex)))
        {
            ...
            if (endpoint -> ux_endpoint_device -> ux_device_speed != UX_HIGH_SPEED_DEVICE)
            {
                ...
                ((UX_EHCI_ED *)ed -> REF_AS.INTR.ux_ehci_ed_anchor) -> REF_AS.ANCHOR.ux_ehci_ed_microframe_ssplit_count[frindex] --;
            ...
            ((UX_EHCI_ED *)ed -> REF_AS.INTR.ux_ehci_ed_anchor) -> REF_AS.ANCHOR.ux_ehci_ed_microframe_load[frindex] = (USHORT)(((UX_EHCI_ED *)ed -> REF_AS.INTR.ux_ehci_ed_anchor) -> REF_AS.ANCHOR.ux_ehci_ed_microframe_load[frindex] - max_packet_size);
