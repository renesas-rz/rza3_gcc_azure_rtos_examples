...
#ifdef USE_SAMPLE_AZURE_IOT_EMBEDDED_SDK
...
static ULONG sample_telemetry_thread_stack[SAMPLE_STACK_SIZE / sizeof(ULONG)] BSP_ALIGN_VARIABLE(8);
#endif /* DISABLE_TELEMETRY_SAMPLE */

#ifndef DISABLE_C2D_SAMPLE
static TX_THREAD sample_c2d_thread;
static ULONG sample_c2d_thread_stack[SAMPLE_STACK_SIZE / sizeof(ULONG)] BSP_ALIGN_VARIABLE(8);
...
static ULONG sample_direct_method_thread_stack[SAMPLE_STACK_SIZE / sizeof(ULONG)] BSP_ALIGN_VARIABLE(8);
...
static ULONG sample_device_twin_thread_stack[SAMPLE_STACK_SIZE / sizeof(ULONG)] BSP_ALIGN_VARIABLE(8);
...
#endif /*USE_SAMPLE_AZURE_IOT_EMBEDDED_SDK*/
