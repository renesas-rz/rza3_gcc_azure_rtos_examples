...
#endif
#define G_PACKET_POOL1_PACKET_SIZE (1568)
#define G_PACKET_POOL1_PACKET_NUM  (64)
extern NX_PACKET_POOL g_packet_pool1;
extern uint8_t g_packet_pool1_pool_memory[(G_PACKET_POOL1_PACKET_NUM * (G_PACKET_POOL1_PACKET_SIZE + sizeof(NX_PACKET)))];

/* Quick Setup for g_packet_pool1 instance. */
void g_packet_pool1_quick_setup();
...
#define G_IP0_TASK_STACK_SIZE (8192)
