 ...
 * Macro definitions
 **********************************************************************************************************************/
#define GETHER_PHY_CFG_USE_PHY (5)
...
typedef struct st_ether_phy_api
{
     ...
     * @par Implemented as
     * - @ref R_GETHER_PHY_StartAutoNegotiate()
     *
     * @param[in]  p_api_ctrl       Pointer to control structure.
     */
     ...
     * @par Implemented as
     * - @ref R_GETHER_PHY_LinkPartnerAbilityGet()
     *
     * @param[in]  p_api_ctrl       Pointer to control structure.
     ...
     * @par Implemented as
     * - @ref R_GETHER_PHY_LinkStatusGet()
     *
     * @param[in]  p_api_ctrl       Pointer to control structure.
     */
