...
GX_STUDIO_ACTION main_screen_id_ppt_percenton_user_event_fade_out_home_windowactions[2] = {
    {GX_ACTION_TYPE_ANIMATION, 0, &main_screen, &main_screen.main_screen_home_window, &main_screen_animation_1},
    {0, 0, GX_NULL, GX_NULL, GX_NULL}
};


GX_STUDIO_ACTION main_screen_id_ppt_percenton_user_event_fade_in_home_windowactions[2] = {
...
static GX_STUDIO_EVENT_ENTRY gx_studio_main_screen_event_table[] = {
    { USER_EVENT_FADE_OUT_HOME_WINDOW, 0, main_screen_id_ppt_percenton_user_event_fade_out_home_windowactions},
    { USER_EVENT_FADE_IN_HOME_WINDOW, 0, main_screen_id_ppt_percenton_user_event_fade_in_home_windowactions},
    {0, 0, GX_NULL}
};
...
GX_CONST GX_STUDIO_WIDGET main_screen_define =
{
    ...
    GX_COLOR_ID_HARF_TRANSPARENT,            /* normal color id                */
    GX_COLOR_ID_HARF_TRANSPARENT,            /* selected color id              */
    GX_COLOR_ID_HARF_TRANSPARENT,            /* disabled color id              */
    gx_studio_window_create,                 /* create function                */
