...
//extern UINT rz_a3_graphics_driver_setup_24xrgb(GX_DISPLAY *display);
...
/* For Mouse control 2023/02/28 */
extern TX_THREAD mouse_thread;
...
/******************************************************************************************/
/* patient_number_convert function.                                                       */
/******************************************************************************************/
...
/******************************************************************************************/
/* Define init_demo_guix_home_automation function.                                        */
/******************************************************************************************/
VOID init_demo_guix_home_automation(void)
{
    /* create byte pool. */
...
VOID  guix_setup()
{
    ...
    /* Configure display. */
//    gx_studio_display_configure(DISPLAY_1, rz_a3_graphics_driver_setup_24xrgb,
    gx_studio_display_configure(DISPLAY_1, rz_a3_graphics_driver_setup_32argb,
...
/* For Mouse control 2023/02/28 */
    //�}�E�X�̒�`���s���i�摜�͓K�؂Ȃ��̂��Ȃ��������߁A�f�t�H���g�̂��̂����蓖�āj
//    mouse_cursor.gx_mouse_cursor_image_id = GX_PIXELMAP_ID_RADIO_ON;
    mouse_cursor.gx_mouse_cursor_image_id = GX_PIXELMAP_ID_MOUSE_ICON;
//    mouse_cursor.gx_mouse_cursor_image_id = GX_PIXELMAP_ID_FINGER_CURSOR;

    mouse_cursor.gx_mouse_cursor_hotspot_x = 0;
    mouse_cursor.gx_mouse_cursor_hotspot_y = 0;

    //�w�肷��L�����o�X��Rootwindow�̃L�����o�X
