...
COMMAND_SEND_DATA(2,0xD3,0x39)
 ...
 COMMAND_SEND_DATA(0x10,0x20,0)  //Delay for Next command to take effect no idea why
 COMMAND_SEND_DATA(2,0x36,0x03)  //MADCM D1 SS Flip Horizontal (SS), D0 GS Flip Vertical (GS)
