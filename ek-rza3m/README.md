...
- **filex_demo_sdmmc_ek_rza3m**  
  ...
  3. Insert micro SD card into J11 connector on the board.
  4. Confirm the following message is displayed on the terminal.  
...
- **guix_demo_home_automation_ek_rza3m<br> guix_demo_washing_machine_ek_rza3m<br> guix_demo_widget_types_ek_rza3m**
  ...
  The "guix_demo_xxx_rza3_fsp" is a sample project of GUIX.  
...
- **usbx_demo_hmsc_ek_rza3m**
  ...
  2. Connect the USB memory to J7 connector on the board.
